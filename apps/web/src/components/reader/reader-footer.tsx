...
import type { MangaProgressStyle } from "@/lib/reader/manga-settings";
...
export function ReaderFooter({
	...
	const current = comicProgress?.currentPage ?? exploredCharCount;
	const total = comicProgress?.pageCount ?? bookCharCount;
	...
	return (
		...
		>
			...
			{showFooter &&
				total > 0 &&
				graphicalProgress &&
				(comicProgress?.style === "page-lines" ? (
					<div
						role="progressbar"
